...
const char* ssid = "iot07";         // Replace "xxx" with your WiFi SSID
const char* password = "rpw1@iot";      // Replace "xxx" with your WiFi Password
...
String apiKey = "IWsUedrlVDL7";             // Replace "xxx" with your API key
